...
const Key = GObject.registerClass({
    Properties: {
        'key-id': GObject.ParamSpec.uint('key-id', 'keyId', 'A read-write integer property', GObject.ParamFlags.READWRITE, 0, 65535, 0),
    },
...
export const Calculator = GObject.registerClass({
    Properties: {
        font: GObject.ParamSpec.string('font', 'Font family name', 'A read-write string property', GObject.ParamFlags.READWRITE, 'Cantarell'),
    },
}, (_a = class Calculator extends GObject.Object {
